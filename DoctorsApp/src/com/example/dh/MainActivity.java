	...
	public void onListFragmentItemClick(int position) {
		...
		if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
			...
			case 0:
				...
				fragmentTransaction.add(R.id.detail_fragment_container, dp,
						"com.exampe.dh.country.details");
			...
			case 1:
				...
				fragmentTransaction.add(R.id.detail_fragment_container, pl,
						"com.exampe.dh.country.details");
				fragmentTransaction.addToBackStack(null);
				fragmentTransaction.commit();
				break;
			...
			case 2:
				...
				fragmentTransaction.add(R.id.detail_fragment_container,
						objAddPatient, "com.exampe.dh.country.details");
				fragmentTransaction.addToBackStack(null);
				fragmentTransaction.commit();
				break;
			...
			case 3:
				...
				fragmentTransaction.add(R.id.detail_fragment_container, amtc,
						"com.exampe.dh.country.details");
				fragmentTransaction.addToBackStack(null);
				fragmentTransaction.commit();
				break;
