...
public class CustomListAddDisease extends BaseAdapter {
	...
	public CustomListAddDisease(Context context,
			ArrayList<ListDataDisease> myList) {
	...
	public View getView(final int position, View convertView,
		...
		if (convertView == null) {
			...
			holderMain.textViewCounter = (TextView) convertView
					.findViewById(R.id.textViewDiseaseCounter);

			holderMain.editTextDiseasename = (EditText) convertView
					.findViewById(R.id.editTextAddDisease);
			holderMain.buttonDone = (ToggleButton) convertView
					.findViewById(R.id.buttonDoneDisease);
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked) {
							...
							if (holderMain.editTextDiseasename.getText()
								...
								Log.d("parameter name values", ""
										+ holderMain.editTextDiseasename
												.getText().toString());
								...
								int diseaseId = pc.saveDiseaseDiagnosed(
										historyId,
										holderMain.editTextDiseasename
												.getText().toString());

								p.getDisease().add(
										pc.getDiseaseFromId(diseaseId));

								m.setParametername(holderMain.editTextDiseasename
										.getText().toString());
