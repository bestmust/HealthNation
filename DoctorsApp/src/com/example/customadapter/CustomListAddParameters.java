...
public class CustomListAddParameters extends BaseAdapter {
	...
	public CustomListAddParameters(Context context,
			ArrayList<ListDataParameters> myList) {
	...
	public View getView(final int position, View convertView,
		...
		if (convertView == null) {
			...
			holderMain.textViewCounter = (TextView) convertView
					.findViewById(R.id.textViewParameterCounter);

			holderMain.editTextParametername = (EditText) convertView
					.findViewById(R.id.editTextAddParameter);
			holderMain.editTextParameterValue = (EditText) convertView
					.findViewById(R.id.editTextAddParameterValue);
			holderMain.buttonDone = (ToggleButton) convertView
					.findViewById(R.id.buttonDoneParameter);
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked) {
							...
							if (holderMain.editTextParametername.getText()
							...
							} else if (holderMain.editTextParameterValue
								...
								Log.d("parameter name values", ""
										+ holderMain.editTextParametername
												.getText().toString());
								Log.d("paratmeter values", ""
										+ holderMain.editTextParameterValue
												.getText().toString());

								// objClinicModel.setUserNames(holderMain.autoTextView.getText().toString());
								objParameterModel.setPatameters(
										holderMain.editTextParametername
												.getText().toString(),
										holderMain.editTextParameterValue
												.getText().toString());
								m.setParametername(holderMain.editTextParametername
										.getText().toString());
								m.setParameterValue(holderMain.editTextParameterValue
										.getText().toString());
								...
								int parameterId = pc.saveParameter(historyId,
										holderMain.editTextParametername
												.getText().toString(),
										holderMain.editTextParameterValue
												.getText().toString());
								p.getParameters().add(
										pc.getParameter(parameterId));

								disableFields();
								Log.d("get array",
										"" + objParameterModel.getparameters());
