...
public class CustomListAddSymptoms extends BaseAdapter {
	...
	public CustomListAddSymptoms(Context context,
			ArrayList<ListDataSymptoms> myList) {
	...
	public View getView(final int position, View convertView,
		...
		if (convertView == null) {
			...
			holderMain.textViewCounter = (TextView) convertView
					.findViewById(R.id.textViewSymptomCounter);

			holderMain.editTextSymptomname = (EditText) convertView
					.findViewById(R.id.editTextAddSymptom);
			holderMain.buttonDone = (ToggleButton) convertView
					.findViewById(R.id.buttonDoneSymptom);
		...
		holderMain.editTextSymptomname.setText(objDataSymptoms
				.getParametername());
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked) {
							...
							if (holderMain.editTextSymptomname.getText()
								...
								Log.d("Symptom name values", ""
										+ holderMain.editTextSymptomname
												.getText().toString());

								p = Prescription.get(activity);
								int historyId = p.getHistoryId();
								pc = new PrescriptionController(activity);
								int symptomId = pc.saveSymptom(historyId,
										holderMain.editTextSymptomname
												.getText().toString());
								...
								objDataSymptoms
										.setParametername(holderMain.editTextSymptomname
												.getText().toString());
								disableFields();
							}
						} else {
