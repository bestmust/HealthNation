...
public class CustomListAddMedicines extends BaseAdapter {
	...
	public CustomListAddMedicines(Context context,
			List<ListDataMedicines> movieItems) {
	...
	public View getView(final int position, View convertView,
		...
		if (convertView == null) {
			...
			holderMain.textViewCounter = (TextView) convertView
					.findViewById(R.id.textViewMedicineCounter);
			holderMain.autoTextView = (AutoCompleteTextView) convertView
					.findViewById(R.id.editTextAddMedicine);
			holderMain.buttonDone = (ToggleButton) convertView
					.findViewById(R.id.buttonDone);

			holderMain.checkBoxMorning = (CheckBox) convertView
					.findViewById(R.id.checkBoxMorning);
			holderMain.checkBoxAfternoon = (CheckBox) convertView
					.findViewById(R.id.checkBoxAfternoon);
			holderMain.checkBoxEvening = (CheckBox) convertView
					.findViewById(R.id.checkBoxEvening);
			holderMain.checkBoxNight = (CheckBox) convertView
		...
		holderMain.checkBoxAfternoon.setChecked(objListDataMedicines
				.isAfternoon());
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked) {
							...
							if (holderMain.autoTextView.getText().toString()
									.equalsIgnoreCase("")) {
								...
								Log.d("auto values", ""
										+ holderMain.autoTextView.getText()
												.toString());
								objClinicModel
										.setUserNames(holderMain.autoTextView
												.getText().toString());
								getValuesOfCheckboxes();
								objListDataMedicines
										.setMedicineName(holderMain.autoTextView
												.getText().toString());
								objListDataMedicines
										.setMorning(holderMain.checkBoxMorning
												.isChecked());
								objListDataMedicines
										.setAfternoon(holderMain.checkBoxAfternoon
												.isChecked());
								objListDataMedicines
										.setEvening(holderMain.checkBoxEvening
												.isChecked());
								objListDataMedicines
										.setNight(holderMain.checkBoxNight
												.isChecked());

								pc = new PrescriptionController(activity);
								p = Prescription.get(activity);
								int medicineDataId = pc
										.savePrescriptionMedicine(p
												.getHistoryId(), 0,
												holderMain.autoTextView
														.getText().toString(),
												holderMain.checkBoxMorning
														.isChecked(),
												holderMain.checkBoxAfternoon
														.isChecked(),
												holderMain.checkBoxEvening
														.isChecked(),
												holderMain.checkBoxNight
														.isChecked());

								p.getMedicine()
										.add(pc.getPrescriptionMedicineFromId(medicineDataId));

								disabledFields();
							}

							Log.d("Array is:",
									"" + objClinicModel.getUserNames());
					...
					private void getValuesOfCheckboxes() {
						...
						if (holderMain.checkBoxMorning.isChecked()) {
							Log.d("Checked is", ""
									+ holderMain.checkBoxMorning.getText()
											.toString());
						}
						if (holderMain.checkBoxAfternoon.isChecked()) {
							Log.d("Checked is", ""
									+ holderMain.checkBoxAfternoon.getText()
											.toString());
						}
						if (holderMain.checkBoxEvening.isChecked()) {
							Log.d("Checked is", ""
									+ holderMain.checkBoxEvening.getText()
											.toString());
						}
						if (holderMain.checkBoxNight.isChecked()) {
							Log.d("Checked is", ""
									+ holderMain.checkBoxNight.getText()
											.toString());
						}
					}
				});
